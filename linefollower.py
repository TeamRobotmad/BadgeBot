...
# PID Gains - Defaults (zero = PID disabled, bang-bang used instead)
_PID_KP = 0.0
_PID_KI = 0.0
_PID_KD = 0.0
...
class LineFollowerApp(app.App):
    def __init__(self):
        ...
        self._settings['pid_kp']         = MySetting(self._settings, _PID_KP, 0.0, 100000.0)
        self._settings['pid_ki']         = MySetting(self._settings, _PID_KI, 0.0, 100000.0)
        self._settings['pid_kd']         = MySetting(self._settings, _PID_KD, 0.0, 100000.0)
